        ...
        <div class="container">
            <div class="nav__navbar">
                ...
                <div class="nav__wrapper">
                    ...
                    <?php wp_nav_menu(array('theme_location' => 'header-menu', 'container_class' => 'nav__menu active')); ?>
                    <?php wp_nav_menu(array('theme_location' => 'categories-menu', 'container_class' => 'nav__categories')); ?>
                    <?php wp_nav_menu(array('theme_location' => 'account-menu', 'container_class' => 'nav__account')); ?>
                ...
                <div class="nav__top-boxes">
                    <div class="nav__top-left">
                        ...
                        <p>
                            ...
                            <a href="tel:+48519833388">+48 519 833 388</a>
                        </p>
                    </div>
